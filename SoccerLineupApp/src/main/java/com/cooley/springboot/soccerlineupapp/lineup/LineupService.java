...
public class LineupService {
	...
	public void addPlayer(String name, String position, int number, String team) {
	...
	public void deleteById(int id){
		...
		Predicate<? super Player> predicate = todo -> todo.getId() == id;
		lineup.removeIf(predicate);
...
//		}
	...
	public Player findById(int id) {
		...
		Player player = lineup.stream().filter(predicate).findFirst().get();
	...
	public void updatePlayer(int id, String name, String position, int number, String team) {
